...
Supercluster.prototype.getChildren = function getChildren (clusterId) {
    var ref = this._decodeClusterId(clusterId);
        var originId = ref.originId;
        var originZoom = ref.originZoom;
...
Supercluster.prototype.getClusterExpansionZoom = function getClusterExpansionZoom (clusterId) {
    var expansionZoom = this._decodeClusterId(clusterId).originZoom - 1;
...
Supercluster.prototype._decodeClusterId = function _decodeClusterId (clusterId) {
    var decremented = clusterId - this.points.length;
    var originId = decremented >> 5;
    var originZoom = decremented % 32;
    return {originZoom: originZoom, originId: originId};
};
